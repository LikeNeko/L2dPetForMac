...
exports.hitModel = exports.LAppDelegate = exports.t_gl = exports.t_canvas = exports.lAppDelegateEvent = exports.scale = exports.frameBuffer = exports.gl = exports.s_instance = exports.canvas = void 0;
...
var LAppDelegate = (function () {
    ...
    LAppDelegate.prototype.initialize = function () {
        ...
        exports.t_canvas = document.createElement('canvas');
        exports.t_canvas.width = exports.canvas.width;
        exports.t_canvas.height = exports.canvas.height;
        exports.t_canvas.style.width = exports.canvas.width + 'px';
        exports.t_canvas.style.height = exports.canvas.height + 'px';
        exports.t_canvas.width = exports.canvas.width * exports.scale;
        exports.t_canvas.height = exports.canvas.height * exports.scale;
        exports.t_gl = exports.t_canvas.getContext("2d");
    ...
    LAppDelegate.prototype.run = function () {
        ...
        var loop = function () {
            ...
            exports.gl.blendFunc(exports.gl.SRC_ALPHA, exports.gl.ONE_MINUS_SRC_ALPHA);
            _this._view.render();
            exports.t_gl.drawImage(exports.canvas, 0, 0);
...
function hitModel(posX, posY) {
    return exports.t_gl.getImageData(0, 0, exports.canvas.width, exports.canvas.height).data[((posY * (exports.canvas.width * 4)) + (posX * 4)) + 3] > 0;
}
exports.hitModel = hitModel;
function onMouseMoved(e) {
    var remote = require('electron').remote;
    var curr_window = remote.getCurrentWindow();
    if (!hitModel(e.clientX * exports.scale, e.clientY * exports.scale)) {
